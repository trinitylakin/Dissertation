*******************************************************************************
*******************************************************************************
        *** Merging Faculty and Institutional Characteristics Data ***
                     ** IPEDS 2015 through 2023 **
*******************************************************************************
*******************************************************************************

log using "\\smb-isl01.fsu.edu\citrix\tal15b\Documents\diss\IPEDS\IPEDS 2015 through 2023\2 Merge Faculty and IC Data 2015-2023.log", replace

*******************************************************************************
*******************************************************************************

use "\\smb-isl01.fsu.edu\citrix\tal15b\Documents\diss\IPEDS\IPEDS 2015 through 2023\Inst Char\1b Clean Institutional Characteristics 2015-2023.dta"

merge m:m unitid year using "\\smb-isl01.fsu.edu\citrix\tal15b\Documents\diss\IPEDS\IPEDS 2015 through 2023\Faculty\1a Clean Faculty 2015-2023 Condensed Races.dta", nogenerate
...
save "\\smb-isl01.fsu.edu\citrix\tal15b\Documents\diss\IPEDS\IPEDS 2015 through 2023\2 Merged Faculty and IC Data 2015-2023.dta", replace
